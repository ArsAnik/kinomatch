...
const Button_ok_no = (props) => {
    ...
    return (
        <div className="btn_block">
            <a className="btn_choice_ok" onClick={() => {editFilm(props.idF, true, true).then(() => props.onBtnClick(true))}}>
            ...
            <a className="btn_choice_no" onClick={() => {deleteFilm(props.idF,false,false).then(() => props.onBtnClick(true))}}>
