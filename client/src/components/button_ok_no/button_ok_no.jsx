...
import {addWatchedFilm, deleteFilm} from "../../action/film.js";

const Button_ok_no = (props) => {

    return (
        <div className="btn_block">
            <a className="btn_choice_ok" onClick={() => addWatchedFilm(props.idU,props.idF)}>
            ...
            <a className="btn_choice_no" onClick={() => deleteFilm(props.idU,props.idF)}>
