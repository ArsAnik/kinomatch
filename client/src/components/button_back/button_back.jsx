...
const Button_back = (props) => {
    ...
    return (
        <button onClick={() => navigate(-1)} className="button_back" >
            <svg className="img_btn_back" width="27.000000" height="13.000000" viewBox="0 0 27 13" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
