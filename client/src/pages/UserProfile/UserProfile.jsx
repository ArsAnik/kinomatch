        ...
        <div className="profile">
            ...
            <div className="profile_btn_block">
                ...
                <div className="profile_settings">
                    <a href={"/settings"} className="profile_btn_settings">
